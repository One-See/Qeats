...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    Restaurant[] restaurants1 = objectMapper.readValue(fixture, Restaurant[].class);

    fixture =
        FixtureHelpers.fixture(FIXTURES + "/peak_hours_list_of_restaurants.json");
    Restaurant[] restaurants2 = objectMapper.readValue(fixture, Restaurant[].class);

    List<Restaurant> restaurantList1 = new ArrayList<Restaurant>(Arrays.asList(restaurants1));
    List<Restaurant> restaurantList2 = new ArrayList<Restaurant>(Arrays.asList(restaurants2));
    ...
    GetRestaurantsResponse allRestaurantsCloseByOffPeakHours = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(20.0, 30.2),
    LocalTime.of(3, 0));
    GetRestaurantsResponse allRestaurantsCloseByPeakHours = restaurantService.findAllRestaurantsCloseBy(new GetRestaurantsRequest(21.0, 31.1),
    LocalTime.of(19, 0));
