...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(
    ...
    if (!(getRestaurantsRequest.getLatitude() >= -90 && getRestaurantsRequest.getLatitude() <= 90) || !(getRestaurantsRequest.getLongitude() >= -180 && getRestaurantsRequest.getLongitude() < -180)) {
      return ResponseEntity.badRequest().body(null);
    }
